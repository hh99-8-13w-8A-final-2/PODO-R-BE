...
public class MusicalController {
    ...
    // 메인화면 데이터베이스 전체 뮤지컬 가져오기
    @GetMapping("/api/musicals/all")
    public ResponseEntity<?> getAllMusical() {
        List<MusicalListResponseDto> responseDto = musicalService.getAllMusical();
